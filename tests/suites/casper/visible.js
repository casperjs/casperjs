/*global casper*/
/*jshint strict:false*/
casper.test.begin('visibility tests', 6, function(test) {
    casper.start('tests/site/visible.html', function() {
        ...
        this.waitUntilVisible('#img1', function() {
            test.pass('Casper.waitUntilVisible() can wait until an element is visible');
        }, function() {
            test.fail('Casper.waitUntilVisible() can wait until an element is visible');
        }, 2000);
	this.waitWhileVisible('#img2', function() {
